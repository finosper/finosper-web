    ...
    return (
        <div ref={containerRef} className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-4">
            ...
            <button
                ...
                className={`flex h-14 w-14 items-center justify-center rounded-full bg-navy text-white shadow-elevated transition-transform hover:scale-105 active:scale-95 rotate-45`}
            >
                <motion.div animate={{ rotate: 45 }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
                    <X className="h-6 w-6" />
                </motion.div>
            </button>
        </div>
